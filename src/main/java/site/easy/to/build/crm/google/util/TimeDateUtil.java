...
public class TimeDateUtil {
    ...
    public static Map<String, String> extractDateTime(String dateTime) {
        ...
        // Si dateTime est null ou vide, retourner une map vide ou avec des valeurs par défaut
        if (dateTime == null || dateTime.trim().isEmpty()) {
            dateTimeParts.put("date", "");
            dateTimeParts.put("time", "");
            dateTimeParts.put("timeZone", "");
            return dateTimeParts;
        }
        ...
        try {
            ...
            // En cas d'erreur (format invalide), retourner des valeurs par défaut
            dateTimeParts.put("date", "");
            dateTimeParts.put("time", "");
            dateTimeParts.put("timeZone", "");
        }
